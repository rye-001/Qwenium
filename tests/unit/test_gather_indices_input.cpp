...
TEST(GatherIndicesInput, NKvLenStride) {
    const uint32_t n_batch = 3, n_kv_len = 5;
    std::vector<int32_t> toks(n_batch, 0);
    ...
    GatherIndicesInput in(GatherIndicesInput::Stride::NKvLen);
    in.set_input(step);
