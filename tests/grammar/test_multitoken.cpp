// test_multitoken.cpp
// Multi-token literal tests adapted for qinf::GrammarVocab.
//
...
class TokenAcceptor {
public:
    TokenAcceptor(qinf::GrammarVocab* g, const std::vector<std::string>& v)
        : grammar(g), vocab(v) {}
...
{
    auto g = qinf::GrammarVocab::parse_impl(MULTITOKEN_GRAMMAR);
    ASSERT_NE(g, nullptr);
}
...
{
    auto g = qinf::GrammarVocab::parse_impl(TWO_TOKEN_GRAMMAR);
    ASSERT_NE(g, nullptr);
...
{
    auto g = qinf::GrammarVocab::parse_impl(ALTERNATIVES_GRAMMAR);
    ASSERT_NE(g, nullptr);
...
{
    auto g = qinf::GrammarVocab::parse_impl(SEQUENCE_GRAMMAR);
    ASSERT_NE(g, nullptr);
...
{
    auto g = qinf::GrammarVocab::parse_impl(REPEAT_GRAMMAR);
    ASSERT_NE(g, nullptr);
...
{
    auto g = qinf::GrammarVocab::parse_impl(REALISTIC_GRAMMAR);
    ASSERT_NE(g, nullptr);
